...
# COMMON="-wandb -data C:/DATA/data/processed/p12_std_hosp/ -epoch 30 -per 50 -w_pos -batch_size 8  -lr 0.00245"
COMMON="-wandb -data C:/DATA/data/processed/p12_full_seft/ -epoch 50 -per 100 -w_pos -batch_size 8  -lr 0.00245"


# COMMON="-wandb -data C:/DATA/data/processed/physio2019_1d_HP_std_AB/ -epoch 15 -per 50  "


# python Optuna1.py $COMMON -event_enc 1 -state -mod none -next_mark 0    -sample_label 1            -user_prefix '[Op]TEDA__label-'
python Optuna1.py $COMMON -event_enc 0 -state -demo -mod none -next_mark 0    -sample_label 1            -user_prefix '[Opt]DA__label-'
...
# # for hospital-based split
# COMMON="-data C:/DATA/data/processed/p12_std_hosp/ -epoch 30 -per 50 -w_pos -unbalanced_batch"
