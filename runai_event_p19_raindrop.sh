...
USER_PREFIX=RD-simpler2-SAHPxavier-LRhigher-bs32-
...
HPs="-batch_size 32  -lr 0.01 -weight_decay 1 -te_d_mark 8 -te_d_time 4 -te_d_inner 32 -te_d_k 8 -te_d_v 8" # simpler2
