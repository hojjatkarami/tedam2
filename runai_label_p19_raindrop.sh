...
USER_PREFIX=RD2-wpos03-Complex2-BiasTrue-Simpler2-LR
...
HPs="-batch_size 256  -lr 0.001 -weight_decay 1 -w_pos_label 0.3 -te_d_mark 8 -te_d_time 4 -te_d_inner 32 -te_d_k 8 -te_d_v 8" # simpler2
